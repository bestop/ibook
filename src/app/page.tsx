                ...
                <DialogContent className="max-h-[80vh] overflow-y-auto rounded-3xl">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-left text-sm font-bold leading-relaxed">
                      「学习闯关岛」覆盖一至六年级上册共 17 个科目岛（六年级语文分六三制/五四学制两个版本）：
                      ...
                      语文为统编教材（六上分六三制/五四学制两版），数学/英语为沪教版（上海教育出版社）。共 154 关 1540 道精选题，全部带详细解析。顶部左上角可切换年级、册别和版本，建议每天玩 20 分钟。
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-3 text-sm leading-relaxed text-gray-600">
                    <div className="rounded-2xl bg-amber-50 p-3">
                      <p className="font-black text-amber-700">⏰ 每天 20 分钟怎么安排？</p>
                      <p>1 关 ≈ 10 题 ≈ 5-8 分钟。推荐「闯 2 关（约 12 分钟）+ 复习错题（约 5 分钟）+ 每日挑战（约 3 分钟）」，十七个科目岛可以搭配着玩。今日学习时长会自动累计。</p>
                    </div>
                    <div className="rounded-2xl bg-emerald-50 p-3">
                      <p className="font-black text-emerald-700">🎁 奖励机制</p>
                      <p>· 答对 1 题 +10 金币；连击 3 次以上每题再 +5<br />· 通关奖励：1 星 +20 / 2 星 +50 / 3 星 +100<br />· 每日任务（闯关/20分钟/复习错题）各有金币奖励<br />· 每日签到 +10 金币，34 个成就徽章等你解锁</p>
                    </div>
