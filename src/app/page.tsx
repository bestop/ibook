                ...
                <DialogContent className="max-h-[80vh] overflow-y-auto rounded-3xl">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-left text-sm font-bold leading-relaxed">
                      「学习闯关岛」覆盖一至六年级上册共 25 个科目岛（各年级数学分沪教/人教两版，六上语文、数学、英语另分六三制/五四学制）：
                      🌸 一年级语文（8 关，2024 秋版）· 🧸 一年级数学·沪教（7 关）· 🐻 一年级数学·人教（7 关，2024 新版）· 🐤 一年级英语（14 关，含 3 个语音角）·
                      🐸 二年级语文（8 关）· 🪀 二年级数学·沪教（8 关）· 🐿️ 二年级数学·人教（7 关，2025 新版）· 🐣 二年级英语（11 关）·
                      🌱 三年级语文（8 关）· 🪁 三年级数学·沪教（9 关，含七巧板）· 🦊 三年级数学·人教（8 关，含曹冲称象）· 🌈 三年级英语（11 关）·
                      🐉 四年级语文（8 关）· 🚀 四年级数学·沪教（9 关，含抽屉原理）· 🐼 四年级数学·人教（9 关，含寻找宝藏）· ⛵ 四年级英语（11 关）·
                      🏮 五年级语文（8 关）· 🧮 五年级数学·沪教（8 关）· 🦉 五年级数学·人教（9 关，含有趣的密铺）· 🔤 五年级英语（11 关）·
                      🦌 六年级语文·六三制（8 关，2026 秋版）· 🌿 六年级语文·五四学制（7 关，2024 秋版）·
                      📏 六年级数学·六三制（9 关，2026 新版人教版）· 🎲 六年级数学·五四学制（8 关，沪教版预备年级）·
                      🐬 六年级英语·沪教版新教材（7 关，五四学制预备年级）。
                      语文为人教社统编教材（六上分六三制/五四学制两版）；数学一至五年级分沪教版与人教版两版（人教版为 2024～2026 秋新版），六年级上册分六三制人教版/五四学制沪教版两版；英语为沪教版（上海教育出版社，六上为 2024 新教材预备年级）。共 218 关 2180 道精选题，全部带详细解析。顶部左上角可切换年级、册别和版本，建议每天玩 20 分钟。
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-3 text-sm leading-relaxed text-gray-600">
                    <div className="rounded-2xl bg-amber-50 p-3">
                      <p className="font-black text-amber-700">⏰ 每天 20 分钟怎么安排？</p>
                      <p>1 关 ≈ 10 题 ≈ 5-8 分钟。推荐「闯 2 关（约 12 分钟）+ 复习错题（约 5 分钟）+ 每日挑战（约 3 分钟）」，二十五个科目岛可以搭配着玩。今日学习时长会自动累计。</p>
                    </div>
                    <div className="rounded-2xl bg-emerald-50 p-3">
                      <p className="font-black text-emerald-700">🎁 奖励机制</p>
                      <p>· 答对 1 题 +10 金币；连击 3 次以上每题再 +5<br />· 通关奖励：1 星 +20 / 2 星 +50 / 3 星 +100<br />· 每日任务（闯关/20分钟/复习错题）各有金币奖励<br />· 每日签到 +10 金币，45 个成就徽章等你解锁</p>
                    </div>
