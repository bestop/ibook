...
export const metadata: Metadata = {
  ...
  description:
    "童学冒险岛：语文、数学一至六年级上下册＋英语一至六年级上册闯关学习游戏，覆盖统编/沪教/人教（PEP）2024～2026 最新教材，共 50 个科目岛、402 关 4020 道精选题，每题带详细解析（六年级均分六三制/五四学制）。每日 20 分钟、金币兑换亲子奖励（礼物屋）、错题本与成就体系，让孩子在游戏中爱上学习。",
