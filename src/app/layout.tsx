...
export const metadata: Metadata = {
  title: "小明乐学岛 | 一至六年级语数外闯关小游戏",
  description:
    "小明乐学岛：一至六年级语文、数学、英语闯关学习游戏，覆盖统编/沪教/人教（PEP）2024～2026 秋最新教材，共 31 个科目岛、258 关 2580 道精选题，每题带详细解析。每日 20 分钟、金币兑换亲子奖励（礼物屋）、错题本与成就体系，让孩子在游戏中爱上学习。",
