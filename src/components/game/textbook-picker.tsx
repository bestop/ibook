...
// 一～五年级：语文统编（人教社）；数学、英语各分沪教版与人教版两个版本
const BASE_PUBLISHER_OPTIONS: { key: PubOptionKey; label: string }[] = [
  { key: 'all', label: '全部版本' },
  { key: 'she', label: '上海教育出版社（沪教数学 + 沪教英语）' },
  { key: 'rj', label: '人民教育出版社（统编语文 + 人教数学 + PEP英语）' },
]

// 六年级语文、数学、英语分六三制与五四学制两个版本：六三制＝统编语文+人教数学+PEP英语（人教社），五四学制＝沪教数学+沪教英语（沪教社），另含统编语文五四学制版
const G6_PUBLISHER_OPTIONS: { key: PubOptionKey; label: string }[] = [
  { key: 'all', label: '全部版本' },
  { key: 'rj', label: '六三制 · 人民教育出版社（语文 + 数学 + PEP英语）' },
...
// 下册：目前已开放统编语文（六年级分六三制/五四学制）、人教版数学与 PEP 英语（六三制）与沪教版数学（五四学制）一至六年级，英语沪教版下册建设中
const B_PUBLISHER_OPTIONS: { key: PubOptionKey; label: string }[] = [
  { key: 'all', label: '全部版本' },
  { key: 'rj', label: '人民教育出版社（统编语文 + 人教数学 + PEP英语 · 六三制）' },
  { key: 'rj54', label: '人民教育出版社 · 统编语文（五·四学制）' },
  { key: 'she', label: '上海教育出版社（沪教数学·五四学制）' },
]
        ...
        <DialogContent className="max-h-[80vh] overflow-y-auto rounded-3xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {textbook.term === 'b' && (
                <p className="mb-2 text-[11px] font-bold text-violet-400">下册已开放统编语文一至六年级（六年级含六三制/五四学制）、人教版数学与 PEP 英语（六三制）以及沪教版数学（五四学制）一至六年级，英语沪教版下册正在建设中～</p>
              )}
              <div className="flex flex-wrap gap-2">
