...
// 下册：目前已开放统编语文（六年级分六三制/五四学制）、人教版数学（六三制）与沪教版数学（五四学制）一至六年级，英语下册建设中
        ...
        <DialogContent className="max-h-[80vh] overflow-y-auto rounded-3xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {textbook.term === 'b' && (
                <p className="mb-2 text-[11px] font-bold text-violet-400">下册已开放统编语文一至六年级（六年级含六三制/五四学制）、人教版数学（六三制）与沪教版数学（五四学制）一至六年级，英语下册正在建设中～</p>
              )}
              <div className="flex flex-wrap gap-2">
