...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  zth3: [
    ...
    { id: 'zth3-9', type: 'judge', q: '公交车上听到报站，要提前准备好下车。', options: ['√ 对', '✗ 错'], answer: 0, explain: '听到自己要下的站名，提前到后门排队，不慌不忙。', tag: '生活常识' },
  ...
  zth4: [
    ...
    { id: 'zth4-6', type: 'judge', q: '说"我喜欢画画"是 I like drawing.。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'draw 画画 → I like drawing. 我喜欢画画。', tag: '句型' },
  ...
  zth6: [
    ...
    { id: 'zth6-7', type: 'choice', q: '说"我喜欢熊猫"，正确的是：', options: ['I like pandas.', 'I like panda.', 'I like a pandas.', 'Me like pandas.'], answer: 0, explain: '喜欢一类动物用复数：I like pandas.。', tag: '语法' },
    { id: 'zth6-8', type: 'choice', q: '问"你喜欢什么动物？"，说：', options: ['What animals do you like?', 'What food do you like?', 'Can you see animals?', 'Where are animals?'], answer: 0, explain: 'What animals do you like? 回答 I like...。', tag: '对话' },
  ...
  zth7: [
    ...
    { id: 'zth7-10', type: 'judge', q: '每个季节都可以用英语说出它的天气特点。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Spring is warm. Summer is hot. Autumn is cool. Winter is cold.。', tag: '句型复习' },
  ],
  zth8: [
  ...
  zth10: [
    ...
    { id: 'zth10-4', type: 'choice', q: '"Can you ride a bicycle?" 的意思是：', options: ['你会骑自行车吗？', '你会开汽车吗？', '你有自行车吗？', '自行车是你的吗？'], answer: 0, explain: 'Can you ride a bicycle? 回答 Yes, I can. / No, I can\'t.。', tag: '句型' },
  ...
  zth11: [
    ...
    { id: 'zth11-9', type: 'judge', q: '爸爸、爷爷、奶奶也为我们付出很多，要同样爱他们。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Father\'s Day 父亲节也别忘了说 I love you, Dad!。', tag: '品德' },
  ...
  zth12: [
    ...
    { id: 'zth12-3', type: 'choice', q: '"I like singing and dancing." 的意思是：', options: ['我喜欢唱歌和跳舞。', '我会唱歌和跳舞。', '我在唱歌跳舞。', '唱歌跳舞很难。'], answer: 0, explain: 'like doing sth.，and 连接两个喜欢做的事。', tag: '句型复习' },
