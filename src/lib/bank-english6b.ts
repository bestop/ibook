...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ztl2: [
    ...
    { id: 'ztl2-5', type: 'judge', q: '交通规则保护每个人的安全，要自觉遵守。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Rules keep us safe. 规则守护安全。', tag: '安全常识' },
  ...
  ztl3: [
    ...
    { id: 'ztl3-2', type: 'choice', q: '中秋节的传统食物是：', options: ['mooncakes 月饼', 'turkey 火鸡', 'Easter eggs 彩蛋', 'dumplings 只有饺子'], answer: 0, explain: '中秋节 mooncakes，月圆人团圆。', tag: '文化常识' },
    ...
    { id: 'ztl3-9', type: 'judge', q: '西方圣诞节 Christmas 在 12 月 25 日。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'December 25th Christmas，Merry Christmas!。', tag: '文化常识' },
  ...
  ztl4: [
    ...
    { id: 'ztl4-9', type: 'judge', q: '高温天要注意防暑：多喝水、避免暴晒。', options: ['√ 对', '✗ 错'], answer: 0, explain: '高温 hot wave 中暑危险，防暑三件套：水、阴凉、休息。', tag: '健康常识' },
  ...
  ztl5: [
    ...
    { id: 'ztl5-9', type: 'judge', q: '白色污染指塑料垃圾，少用一次性塑料袋。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'plastic bags 塑料袋难降解，自带环保袋更 green。', tag: '常识' },
    { id: 'ztl5-10', type: 'choice', q: '设计 ideal green neighbourhood（理想绿色社区），少不了：', options: ['绿植、垃圾分类站、自行车道', '更多的垃圾堆', '更多的尾气', '更多的 Crowded'], answer: 0, explain: '绿意、整洁、低碳出行，理想社区三要素。', tag: '表达' },
  ],
  ztl6: [
    { id: 'ztl6-1', type: 'choice', q: '"Famous people in history" 的意思是：', options: ['历史上的名人', '我的好朋友', '明星演唱会', '运动员'], answer: 0, explain: 'famous 著名的，历史上的人 remains 闪耀。', tag: '短语理解' },
    { id: 'ztl6-2', type: 'choice', q: '"world changers" 的意思是：', options: ['改变世界的人', '环游世界的人', '世界冠军', 'Translator'], answer: 0, explain: 'changer 改变者，伟人们用行动改变世界。', tag: '词汇' },
    { id: 'ztl6-3', type: 'choice', q: '杂交水稻之父袁隆平的英文名是：', options: ['Yuan Longping', 'Tu Youyou', 'Confucius', 'Zheng He'], answer: 0, explain: 'Yuan Longping 让千万人远离饥饿，Fields Medal of farming。', tag: '文化常识' },
    ...
    { id: 'ztl6-9', type: 'judge', q: '名人邮票 stamps 上常有他们的头像和成就。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'E Stamps of famous people：小小邮票致敬伟人。', tag: '常识' },
