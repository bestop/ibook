...
export const QUESTIONS: Record<string, Question[]> = {
  zb1: [
    ...
    { id: 'zb1-3', type: 'choice', q: '"How many pencils?" 是在问：', options: ['有多少支铅笔？', '铅笔是什么颜色？', '铅笔在哪里？', '铅笔多少钱？'], answer: 0, explain: 'How many...? 问数量多少，回答：Five pencils.。', tag: '句型' },
    ...
    { id: 'zb1-10', type: 'choice', q: '数一数：一只手 5 根手指，两只手有几根？', options: ['ten', 'five', 'two', 'one'], answer: 0, explain: '5+5=10，ten ten！我们有一根 ten 手指——Ten fingers!。', tag: '数字' },
  ],
  zb2: [
    ...
    { id: 'zb2-7', type: 'choice', q: '问"它是什么颜色"，应该问：', options: ['What colour is it?', 'What is your name?', 'How many books?', 'Where is it?'], answer: 0, explain: 'What colour is it? 它是什么颜色？回答：It\'s blue.。', tag: '句型' },
    { id: 'zb2-8', type: 'choice', q: '"blue" 的意思是：', options: ['蓝色', '黑色', '黄色', '紫色'], answer: 0, explain: 'blue 蓝色，像天空和大海：The sky is blue.。', tag: '颜色' },
  ...
  zb3: [
    ...
    { id: 'zb3-8', type: 'choice', q: '玩具玩完之后应该：', options: ['收拾好放回原处', '扔在地上', '藏在床底下', '送给别人'], answer: 0, explain: 'Put away your toys. 把玩具收好， tidy and clean 又整洁！', tag: '习惯养成' },
  ...
  zb4: [
    ...
    { id: 'zb4-2', type: 'choice', q: '"sad" 的意思是：', options: ['难过的', '开心的', '生气的', '害怕的'], answer: 0, explain: 'sad 难过的，和 happy 相反，难过时可以说 I\'m sad.。', tag: '情绪' },
    ...
    { id: 'zb4-4', type: 'choice', q: '想知道对方心情怎么样，可以问：', options: ['How do you feel?', 'What is this?', 'How old are you?', 'Where are you from?'], answer: 0, explain: 'How do you feel? 你感觉怎么样？回答：I\'m happy.。', tag: '句型' },
  ...
  zb5: [
    ...
    { id: 'zb5-4', type: 'choice', q: '值日时分工合作，应该：', options: ['各做各的，互相帮助', '都让别人做', '偷懒躲起来', '只擦一小块'], answer: 0, explain: '分工合作效率高：你扫地我擦桌，Many hands make light work!。', tag: '合作' },
