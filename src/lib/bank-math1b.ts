...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  zu7: [
    { id: 'zu7-1', type: 'choice', q: '找规律：10、20、30、40、（ ）。', options: ['50', '45', '60', '41'], answer: 0, explain: '十个十个地数：10、20、30、40、50，正好 5 个十。', tag: '找规律' },
    { id: 'zu7-2', type: 'choice', q: '找规律：12、14、16、18、（ ）。', options: ['20', '19', '21', '22'], answer: 0, explain: '每次多 2：12、14、16、18、20，都是双数！', tag: '找规律' },
    { id: 'zu7-3', type: 'choice', q: '2 件上衣和 2 条裤子，一件上衣配一条裤子，有几种穿法？', options: ['4 种', '2 种', '3 种', '8 种'], answer: 0, explain: '第 1 件上衣配 2 条裤子是 2 种，第 2 件上衣再配 2 条，2 + 2 = 4（种）。', tag: '搭配' },
    ...
    { id: 'zu7-7', type: 'choice', q: '3 顶帽子和 2 条围巾，一顶帽子配一条围巾，有几种搭配？', options: ['6 种', '5 种', '3 种', '9 种'], answer: 0, explain: '1 顶帽子配 2 条围巾是 2 种，3 顶帽子就是 2 + 2 + 2 = 6（种）。', tag: '搭配' },
