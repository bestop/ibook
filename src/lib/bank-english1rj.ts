...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  za2: [
    ...
    { id: 'za2-5', type: 'judge', q: '"This is my teacher." 意思是"这是我的学校"。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'This is... 是"这是……"，teacher 是老师：这句是"这是我的老师"，用来介绍老师；school 才是学校。', tag: '句型' },
  ...
  zar: [
    ...
    { id: 'zar-5', type: 'judge', q: 'schoolbag（书包）是用来装玩具的。', options: ['√ 对', '✗ 错'], answer: 1, explain: '书包是用来装课本和文具的，玩具要留在家里玩哦。', tag: '生活常识' },
