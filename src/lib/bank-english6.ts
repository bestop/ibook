...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  k3: [
    ...
    { id: 'k3-4', type: 'choice', q: '"Would you like some rice?" 想要时的肯定回答是：', options: ['Yes, please.', 'No, thanks.', 'I don\'t know.', 'You\'re welcome.'], answer: 0, explain: '想要就礼貌地说"Yes, please."，不想要就说"No, thanks."。', tag: '句型' },
    ...
    { id: 'k3-10', type: 'judge', q: '只要好吃，暴饮暴食也没关系。', options: ['√ 对', '✗ 错'], answer: 1, explain: '错！挑食、暴饮暴食都是不好的饮食习惯。不挑食、不暴食，营养均衡才能长得好、学得好！', tag: '习惯养成' },
  ],
  k4: [
  ...
  k5: [
    ...
    { id: 'k5-10', type: 'judge', q: '在动物园可以随便投喂动物、拍打玻璃和它们互动。', options: ['√ 对', '✗ 错'], answer: 1, explain: '错！随便投喂可能让动物生病，拍打玻璃会惊吓它们。文明游园，安静观赏，尊重动物的生活习惯。', tag: '品德养成' },
  ],
  k6: [
