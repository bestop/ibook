...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  zf2: [
    ...
    { id: 'zf2-5', type: 'judge', q: '家庭聚会上，只顾自己玩手机、不和家人交流是懂事的表现。', options: ['√ 对', '✗ 错'], answer: 1, explain: '错！团聚时光珍贵，主动帮忙、陪长辈聊天，做贴心小主人！', tag: '品德养成' },
  ...
  zf4: [
    ...
    { id: 'zf4-2', type: 'choice', q: '"pocket money" 指的是：', options: ['零花钱', '工资', '奖学金', '压岁钱'], answer: 0, explain: 'pocket money 零花钱，怎么用零花钱大有学问！', tag: '理财词汇' },
  ...
  zf6: [
    ...
    { id: 'zf6-5', type: 'judge', q: '纸张便宜又常见，随便浪费也不会影响森林。', options: ['√ 对', '✗ 错'], answer: 1, explain: '错！纸张是木头做的，Save paper, save trees. 双面用纸、回收废纸，保护森林资源！', tag: '环保行动' },
