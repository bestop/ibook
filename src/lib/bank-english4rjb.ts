...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ztd2: [
    ...
    { id: 'ztd2-7', type: 'choice', q: '晚上九点还在玩手机，违反了哪类约定？', options: ['作息时间约定', '班级规则', '交通规则', '游戏规则'], answer: 0, explain: '按时睡觉 go to bed on time，作息约定 protects 你的身高和记忆力！', tag: '家规' },
  ...
  ztdr: [
    ...
    { id: 'ztdr-3', type: 'choice', q: '计划表里"先学习后玩耍"用英语说：', options: ['Homework first, then play.', 'Play first, then homework.', 'Only play, no homework.', 'No play, no homework.'], answer: 0, explain: 'first 先、then 然后，先……后……用 first..., then...。', tag: '句型' },
    ...
    { id: 'ztdr-6', type: 'choice', q: '在商店买纪念品 15 元，付 20 元应找回：', options: ['5 元 five yuan', '15 元 fifteen yuan', '10 元 ten yuan', '50 元 fifty yuan'], answer: 0, explain: '20-15=5，找回 5 元，Check the change!。', tag: '数字运用' },
