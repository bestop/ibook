...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ztc4: [
    ...
    { id: 'ztc4-5', type: 'judge', q: '米饭、面条等主食给身体提供能量。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'rice 米饭、noodles 面条是主食，吃饱了才有力气学习！', tag: '营养常识' },
  ...
  ztc5: [
    ...
    { id: 'ztc5-5', type: 'judge', q: '坏掉的玩具修一修，还能继续玩。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Fix it first! 先修一修，old things can be reused 旧物能再利用！', tag: '环保意识' },
  ...
  ztc6: [
    ...
    { id: 'ztc6-5', type: 'judge', q: '坐公交时要看清路线编号，别坐错车。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Bus No. 5 就是 5 路车，看清数字不迷路！', tag: '数字运用' },
  ...
  ztcr: [
    ...
    { id: 'ztcr-7', type: 'choice', q: '摊位上的健康小食可以选：', options: ['fruit salad 水果沙拉', 'spicy chips 辣条', 'cola 可乐', 'ice candy 大量棒棒糖'], answer: 0, explain: 'Healthy food 健康食物当主角，水果沙拉受欢迎！', tag: '健康习惯' },
