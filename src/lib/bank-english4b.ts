...
export const QUESTIONS: Record<string, Question[]> = {
  ztj1: [
    ...
    { id: 'ztj1-7', type: 'choice', q: '问"你能闻到什么？"，说：', options: ['What can you smell?', 'What can you see?', 'What can you hear?', 'What do you like?'], answer: 0, explain: 'What can you smell? 回答 I can smell...。', tag: '句型' },
  ...
  ztj3: [
    ...
    { id: 'ztj3-5', type: 'judge', q: '晚上开灯也能在墙上看到影子。', options: ['√ 对', '✗ 错'], answer: 0, explain: '有光有遮挡就有影子，手影游戏真好玩。', tag: '常识' },
  ...
  ztj4: [
    ...
    { id: 'ztj4-5', type: 'judge', q: 'play basketball 里球类运动前面不加 the。', options: ['√ 对', '✗ 错'], answer: 0, explain: '球类运动 play basketball / football 不加 the；乐器要加 the。', tag: '语法' },
  ...
  ztj8: [
    ...
    { id: 'ztj8-5', type: 'judge', q: '钟面短针指向 3、长针指向 12，是三点整。', options: ['√ 对', '✗ 错'], answer: 0, explain: '短针指小时，长针指 12 就是整点：three o\'clock.。', tag: '常识' },
  ...
  ztj9: [
    ...
    { id: 'ztj9-5', type: 'judge', q: '星期名词的首字母要大写，如 Monday。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Monday, Tuesday... 每个星期单词首字母大写。', tag: '语法' },
  ...
  ztj11: [
    ...
    { id: 'ztj11-6', type: 'judge', q: '"Happy New Year!" 可以用在春节拜年时。', options: ['√ 对', '✗ 错'], answer: 0, explain: '春节也是新年，拜年说 Happy New Year! 或 Happy Chinese New Year!。', tag: '文化常识' },
