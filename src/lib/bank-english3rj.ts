...
export const QUESTIONS: Record<string, Question[]> = {
  zc1: [
    ...
    { id: 'zc1-4', type: 'choice', q: '好朋友的东西掉了，你应该：', options: ['帮他捡起来', '假装没看见', '踩一脚', '藏起来'], answer: 0, explain: '主动帮忙：Let me help you.，互相帮助友谊更深！', tag: '品德养成' },
    ...
    { id: 'zc1-7', type: 'choice', q: '同学不小心撞到你，说 Sorry!，你应该回答：', options: ['That\'s OK.', 'You\'re bad!', 'I\'ll tell the teacher!', 'Go away!'], answer: 0, explain: 'That\'s OK. 没关系。原谅别人的小失误，做宽容的好孩子。', tag: '礼貌用语' },
    ...
    { id: 'zc1-10', type: 'judge', q: '交朋友时要注意听别人说话，不能随便打断。', options: ['√ 对', '✗ 错'], answer: 0, explain: '认真倾听是尊重别人，会倾听的孩子朋友多！', tag: '习惯养成' },
  ],
  zc2: [
  ...
  zc3: [
    ...
    { id: 'zc3-5', type: 'judge', q: 'lion（狮子）和 tiger（老虎）都是 wild animals（野生动物）。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'wild animals 野生动物：lion、tiger、bear、fox……它们生活在大自然里。', tag: '动物词汇' },
  ...
  zc4: [
    ...
    { id: 'zc4-10', type: 'judge', q: '爱护草坪，不踩踏小草，从自己做起。', options: ['√ 对', '✗ 错'], answer: 0, explain: '小草也有生命，绕道走路护小草，做爱护环境的小卫士！', tag: '品德养成' },
  ],
  zc5: [
  ...
  zc6: [
    ...
    { id: 'zc6-9', type: 'judge', q: '过生日时收到礼物要说 Thank you!。', options: ['√ 对', '✗ 错'], answer: 0, explain: '收到礼物大声说 Thank you!，有礼貌的孩子人人爱！', tag: '礼貌用语' },
