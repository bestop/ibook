...
export const QUESTIONS: Record<string, Question[]> = {
  u1: [
    ...
    { id: 'a1-7', type: 'judge', q: '"人"字有三笔：撇、捺，还有一横。', options: ['√ 对', '✗ 错'], answer: 1, explain: '"人"字只有两笔：一撇、一捺，站得稳稳的，像两条腿走路。', tag: '笔画' },
  ...
  u2: [
    ...
    { id: 'a2-4', type: 'choice', q: '"衣服"的"衣"，声母是哪个字母？', options: ['y', 'i', 'e', 'm'], answer: 0, explain: '声母 y 读"衣"，像树杈；单韵母 i 也读"衣"，头上有个小圆点。y 是声母，i 是韵母。', tag: '拼音' },
  ...
  u4: [
    { id: 'a4-1', type: 'choice', q: '"ai"念什么？和"挨着"的"挨"一样吗？', options: ['念 ɑi，和"挨"一样', '念 ia', '念 ui', '念 ei'], answer: 0, explain: 'ɑ i 排队 ɑi ɑi ɑi，"挨着"的"挨"（āi）就有它。复韵母是两个字母一起读。', tag: '复韵母' },
    ...
    { id: 'a4-4', type: 'choice', q: '皮球的"球"读 qiú，它的韵母是：', options: ['iu', 'ou', 'ui', 'ao'], answer: 0, explain: '"球"读 qiú，韵母是 iu。i u 排队 iu iu iu。', tag: '复韵母' },
    ...
    { id: 'a4-7', type: 'judge', q: '"山"的韵母是 ang，"风"的韵母是 en。', options: ['√ 对', '✗ 错'], answer: 1, explain: '山 shān 的韵母 an 是前鼻音；风 fēng 的韵母 eng 是后鼻音。别把它们记反啦！', tag: '鼻韵母' },
  ...
  u7: [
    ...
    { id: 'a7-7', type: 'choice', q: '《两件宝》指的是哪两件宝？', options: ['双手和大脑', '眼睛和耳朵', '铅笔和橡皮', '书和本子'], answer: 0, explain: '《两件宝》：人有哪两件宝？双手和大脑——双手会做工，大脑会思考。', tag: '课文理解' },
