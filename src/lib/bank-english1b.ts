...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ztg2: [
    ...
    { id: 'ztg2-3', type: 'choice', q: '扁扁嘴、呷呷叫的"鸭子"是：', options: ['duck', 'hen', 'dog', 'cat'], answer: 0, explain: 'duck 是鸭子，扁扁的嘴巴呷呷叫，还喜欢在水里游。', tag: '动物词汇' },
    ...
    { id: 'ztg2-6', type: 'choice', q: '用来听声音的耳朵是：', options: ['ears', 'eyes', 'nose', 'mouth'], answer: 0, explain: 'ears 耳朵，两只耳朵用来听声音，Listen and hear！', tag: '常识' },
    { id: 'ztg2-7', type: 'choice', q: '跑得快快的"小马"是：', options: ['horse', 'hen', 'sheep', 'frog'], answer: 0, explain: 'horse 是小马，跑得快快哒哒响。', tag: '动物词汇' },
    ...
    { id: 'ztg2-9', type: 'judge', q: '上课时可以和同桌悄悄聊天，不用听老师讲课。', options: ['√ 对', '✗ 错'], answer: 1, explain: '上课要认真听讲：悄悄聊天会漏掉新本领，还会打扰同学。', tag: '学习习惯' },
  ...
  ztg5: [
    ...
    { id: 'ztg5-5', type: 'judge', q: '"I like sweets." 的意思是"我不喜欢糖果"。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'I like... 是"我喜欢……"，I like sweets. 就是"我喜欢糖果"。糖果好吃，但要少吃防蛀牙哦。', tag: '句型' },
  ...
  ztg6: [
    ...
    { id: 'ztg6-5', type: 'judge', q: '"Drink some water." 的意思是"把水倒掉"。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'Drink 是"喝"，Drink some water. 就是"喝点水"，运动后要及时补水哦。', tag: '句型' },
  ...
  ztg7: [
    ...
    { id: 'ztg7-10', type: 'judge', q: '每个季节都有不同的好玩活动，比如夏天堆雪人、冬天放风筝。', options: ['√ 对', '✗ 错'], answer: 1, explain: '活动要跟着季节走：夏天没有雪，堆雪人是冬天玩的游戏；放风筝要趁春天风大的日子。', tag: '常识' },
  ],
  ztg8: [
  ...
  ztg9: [
    ...
    { id: 'ztg9-5', type: 'judge', q: '冬天冷，要穿薄薄的 shorts（短裤）和 T-shirt。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'shorts 短裤、T-shirt 短袖是夏天的衣服；冬天要穿 sweater 毛衣、coat 外套才暖和。', tag: '常识' },
