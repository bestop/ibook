...
export const QUESTIONS: Record<string, Question[]> = {
  ist: [
    ...
    { id: 'ist-9', type: 'judge', q: '学英语要多听、多说、多唱，像唱歌一样有趣。', options: ['√ 对', '✗ 错'], answer: 0, explain: '英文歌、小游戏都是学英语的好办法，边玩边学最快乐。', tag: '学习习惯' },
  ...
  iipa1: [
    ...
    { id: 'iipa1-5', type: 'judge', q: '字母有大小写，A 和 a 是同一个字母。', options: ['√ 对', '✗ 错'], answer: 0, explain: '每个字母都有大写和小写两种样子，A 是大写，a 是小写。', tag: '字母' },
  ...
  i5: [
    ...
    { id: 'i5-6', type: 'judge', q: '我们有两只眼睛、两只耳朵。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'We have two eyes and two ears. 两只眼睛看，两只耳朵听。', tag: '常识' },
