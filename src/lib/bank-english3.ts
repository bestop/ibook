...
export const QUESTIONS: Record<string, Question[]> = {
  fst: [
    ...
    { id: 'fstq2', type: 'choice', q: '按字母表顺序，A 后面第三个字母是什么？', options: ['D', 'B', 'C', 'E'], answer: 0, explain: '按顺序数：A 后面第一个是 B，第二个是 C，第三个是 D。唱唱字母歌就不容易数错。', tag: '字母表' },
    { id: 'fstq3', type: 'choice', q: '下面哪个字母的发音以 /e/（类似"欸"的短音）开头？', options: ['F', 'A', 'H', 'J'], answer: 0, explain: 'F 读 /ef/，字母名以 /e/ 开头；A 读 /eɪ/，H 读 /eɪtʃ/，J 读 /dʒeɪ/。', tag: '字母发音' },
  ...
  f1: [
    ...
    { id: 'f1q6', type: 'judge', q: 'teacher 的意思是"学校"，school 的意思是"老师"。', options: ['对', '错'], answer: 1, explain: '错！说反啦：teacher 老师（teach 教＋er 的人），school 学校。这两个词是本单元 Topic words。', tag: '单词理解' },
  ...
  f3: [
    ...
    { id: 'f3q8', type: 'choice', q: '课本 Sound 时间学字母 g（garden），g 的发音是？', options: ['/g/', '/dʒ/', '/j/', '/k/'], answer: 0, explain: 'garden 里 g 读 /g/（给）。g 有时也读 /dʒ/（如 giraffe 长颈鹿），但 garden、go、good 中读 /g/。', tag: '语音' },
  ...
  f4: [
    ...
    { id: 'f4q5', type: 'judge', q: '雪的英文是 ice，冰的英文是 snow。', options: ['对', '错'], answer: 1, explain: '错！说反了：ice 冰，snow 雪。水遇冷结冰，冰融化又变回水，水的形态会变化。', tag: '科学常识' },
    { id: 'f4q6', type: 'choice', q: '"I am water. I come from the sea." 中 come from 的用法正确吗？', options: ['正确，主语 I 用 come，第三人称单数才用 comes', '错误，应该说 am come', '错误，要用 coming', '错误，要用 go'], answer: 0, explain: '注意：主语是 I 时用 come from；主语是 he/she/it（第三人称单数）时要说 comes from。I am water 用 I 的时候 come 不加 s。', tag: '语法要点' },
  ...
  f5: [
    ...
    { id: 'f5q5', type: 'choice', q: '妈妈在做饭，你想帮忙收拾桌子，可以说？', options: ['Let me clean the table.', 'Let me cook noodles.', 'Let me sleep.', 'Let me go out.'], answer: 0, explain: 'clean the table 擦桌子、摆桌。Let me... 让我来……，主动帮忙要用这个句型。', tag: '情景交际' },
  ...
  f8: [
    ...
    { id: 'f8q5', type: 'judge', q: '"find the way" 的意思是"修路"。', options: ['对', '错'], answer: 1, explain: '错。find 找到，way 路。find the way 是找到路、认路，不是修路。看地图、记标志物都能帮我们认路。', tag: '单词理解' },
  ...
  f10: [
    ...
    { id: 'f10q5', type: 'judge', q: '"beef" 的意思是"猪肉"。', options: ['对', '错'], answer: 1, explain: '错。beef 牛肉，pork 猪肉，chicken 鸡肉，fish 鱼肉。别弄混哦。', tag: '单词理解' },
    ...
    { id: 'f10q8', type: 'choice', q: '课本 Sound 时间学字母 n（noodles），n 的发音是？', options: ['/n/', '/m/', '/l/', '/ŋ/'], answer: 0, explain: 'n 在词首读 /n/（呢），如 noodles、new、nice。发音时舌尖抵上齿龈，鼻子出气。', tag: '语音' },
