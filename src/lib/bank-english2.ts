...
export const QUESTIONS: Record<string, Question[]> = {
  hst: [
    ...
    { id: 'hst-10', type: 'judge', q: '见到老师同学要主动问好。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Hello! Good morning! 主动问好，做有礼貌的小学生。', tag: '品德' },
  ],
  h1: [
    ...
    { id: 'h1-5', type: 'judge', q: '早上起床后要先刷牙洗脸，再吃早餐。', options: ['√ 对', '✗ 错'], answer: 0, explain: '好习惯：起床、刷牙洗脸、吃早餐，精神饱满去上学。', tag: '常识' },
  ...
  h2: [
    ...
    { id: 'h2-6', type: 'judge', q: '自己的房间自己整理。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Tidy my room 整理房间，被子叠好、玩具归位。', tag: '品德' },
  ...
  h4: [
    ...
    { id: 'h4-5', type: 'judge', q: '经常运动能让身体更强壮。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'Playing sports 多运动，吃饭香、睡得好、身体棒！', tag: '常识' },
  ...
  h5: [
    ...
    { id: 'h5-6', type: 'judge', q: '白天有太阳，晚上常常能看到月亮和星星。', options: ['√ 对', '✗ 错'], answer: 0, explain: '白天太阳上班，晚上月亮星星值班。', tag: '常识' },
    ...
    { id: 'h5-10', type: 'judge', q: '太阳给我们光和热，不能长时间直视太阳。', options: ['√ 对', '✗ 错'], answer: 0, explain: '太阳很亮，盯着看会伤眼睛，看太阳要戴专业眼镜。', tag: '安全' },
  ],
  h6: [
  ...
  h9: [
    ...
    { id: 'h9-4', type: 'choice', q: '用嘴巴"尝"是：', options: ['taste', 'smell', 'see', 'hear'], answer: 0, explain: 'taste 尝味道，甜的甜、酸酸的是 taste 出来的。', tag: '词汇' },
    ...
    { id: 'h9-8', type: 'choice', q: '闻花香用的是：', options: ['nose', 'eyes', 'ears', 'feet'], answer: 0, explain: 'nose 鼻子闻气味，花香 smelly 好香呀！', tag: '常识' },
  ...
  h10: [
    ...
    { id: 'h10-8', type: 'choice', q: '把好朋友介绍给大家，说：', options: ['This is my friend.', 'This is me.', 'I am a boy.', 'Goodbye, friend!'], answer: 0, explain: 'This is my friend. 这是我的朋友，介绍他人用 This is ...。', tag: '句型' },
