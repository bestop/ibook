...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ze3: [
    ...
    { id: 'ze3-2', type: 'choice', q: '"always" 的意思是：', options: ['总是', '从不', '有时', '很少'], answer: 0, explain: 'always 总是，频度最高；> usually > often > sometimes > never。', tag: '频度副词' },
  ...
  ze4: [
    ...
    { id: 'ze4-5', type: 'judge', q: '挑食、不吃蔬菜是坏习惯。', options: ['√ 对', '✗ 错'], answer: 0, explain: '蔬菜有丰富的维生素，不挑食营养均衡，身体才棒棒！', tag: '饮食习惯' },
