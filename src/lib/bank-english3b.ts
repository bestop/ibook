...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  zti2: [
    ...
    { id: 'zti2-7', type: 'judge', q: '"The pillow is soft." 的意思是"枕头是软的"。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'pillow 枕头，soft 软，睡上去舒服极了。', tag: '句型' },
  ...
  zti4: [
    ...
    { id: 'zti4-5', type: 'judge', q: '"The panda is black and white." 的意思是"熊猫是黑白色的"。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'black and white 黑白色，熊猫的标志配色。', tag: '句型' },
  ...
  zti5: [
    ...
    { id: 'zti5-6', type: 'judge', q: '"These kites are beautiful." 的意思是"这些风筝很漂亮"。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'these 这些（复数的近指），单数是 this。', tag: '语法' },
    ...
    { id: 'zti5-9', type: 'judge', q: ' skateboard 滑板车玩的时候要戴好护具。', options: ['√ 对', '✗ 错'], answer: 0, explain: '滑滑板戴头盔和护膝，保护自己不摔伤。', tag: '安全常识' },
  ...
  zti7: [
    ...
    { id: 'zti7-7', type: 'judge', q: '钟表的钟面是 circle 圆形。', options: ['√ 对', '✗ 错'], answer: 0, explain: '钟面圆圆的是圆形，看时间真方便。', tag: '常识' },
  ...
  zti9: [
    ...
    { id: 'zti9-7', type: 'judge', q: '"In autumn, it is cool." 的意思是"秋天天气凉爽"。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'in + 季节表示在某个季节，autumn 凉爽舒适。', tag: '句型' },
    { id: 'zti9-8', type: 'choice', q: '春天 plants 会：', options: ['grow 发芽生长', 'die all 枯死', 'fly away', 'sleep all day'], answer: 0, explain: 'Spring is warm. 万物生长，小芽钻出泥土。', tag: '常识' },
  ...
  zti11: [
    ...
    { id: 'zti11-5', type: 'judge', q: '儿童节收到礼物要说 Thank you.。', options: ['√ 对', '✗ 错'], answer: 0, explain: '收到祝福和礼物，别忘了说谢谢。', tag: '礼貌用语' },
    ...
    { id: 'zti11-7', type: 'choice', q: '气球气球的"气球"是：', options: ['balloon', 'ball', 'doll', 'kite'], answer: 0, explain: 'balloon 气球，节日里飘着彩色气球，注意别爆哦。', tag: '词汇' },
  ...
  zti12: [
    ...
    { id: 'zti12-9', type: 'judge', q: '六月一日是 Children\'s Day 儿童节。', options: ['√ 对', '✗ 错'], answer: 0, explain: 'June 1st 儿童节，属于每个小朋友的节日。', tag: '复习' },
