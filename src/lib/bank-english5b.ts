...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  ztk4: [
    ...
    { id: 'ztk4-5', type: 'judge', q: 'healthy 的意思是"勤劳的"。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'health 是健康，healthy = 健康的；un- 前缀否定，unhealthy = 不健康的。"勤劳的"是 hard-working。', tag: '词汇' },
  ...
  ztk8: [
    ...
    { id: 'ztk8-6', type: 'judge', q: '台风天风大雨大，正好出门玩耍。', options: ['√ 对', '✗ 错'], answer: 1, explain: '台风 typhoon 来时风大雨大，出门很危险，要待在家里，等警报解除再活动。', tag: '安全常识' },
  ...
  ztk9: [
    ...
    { id: 'ztk9-6', type: 'judge', q: 'narrow 的意思是"宽的"。', options: ['√ 对', '✗ 错'], answer: 1, explain: 'narrow 是窄的，wide 才是宽的，它们是一对反义词，对比着记不容易忘。', tag: '词汇' },
