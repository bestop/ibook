...
export const QUESTIONS: Record<string, Question[]> = {
  ztk1: [
    ...
    { id: 'ztk1-8', type: 'choice', q: '"Is this your ruler?" 的回答是：', options: ['Yes, it is mine.', 'Yes, they are mine.', 'No, it isn\'t mine.', 'Both A and C'], answer: 0, explain: '单数问 this...it，答 Yes, it is mine. / No, it isn\'t.，所以两个都对。', tag: '句型' },
  ...
  ztk4: [
    ...
    { id: 'ztk4-9', type: 'judge', q: '一日三餐要按时吃，早餐最重要不能省。', options: ['√ 对', '✗ 错'], answer: 0, explain: '早餐提供上午能量，不吃早餐影响学习。', tag: '健康常识' },
  ...
  ztk5: [
    ...
    { id: 'ztk5-6', type: 'judge', q: '看电影时要对号入座，手机调成静音。', options: ['√ 对', '✗ 错'], answer: 0, explain: '影院礼仪：安静观影，不打扰别人。', tag: '品德' },
  ...
  ztk7: [
    ...
    { id: 'ztk7-2', type: 'choice', q: '"What does this sign mean?" 的意思是：', options: ['这个标志是什么意思？', '这个标志在哪里？', '谁画的标志？', '标志多少钱？'], answer: 0, explain: 'mean 意思是，回答 It means...。', tag: '句型' },
  ...
  ztk8: [
    ...
    { id: 'ztk8-10', type: 'judge', q: '播天气预报时可以自己编：sunny, hot, 35 degrees...。', options: ['√ 对', '✗ 错'], answer: 0, explain: '播报员游戏练习天气表达，like a real weather reporter!。', tag: '拓展' },
  ],
  ztk9: [
